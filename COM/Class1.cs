...
namespace ComObjectForLab
{
    [Guid("50A2D983-C4F2-4845-8CF2-0F9F98D982C7")]
    [ComVisible(true)]
    public interface ISettings
    {
        ...
        //---
        int WallStartX { get; set; }// Координата Х для земли
        int WallStartY { get; set; }  // Координата У для земли
        char Wall { get; set; } // Первоначальная форма земли
        int NumberOfWallRows { get; set; } // Кол-во рядов земли
        int NumberOfWall { get; set; }// Кол-во земли
        //---
    ...
    [Guid("CE3F52C7-518D-4A11-82B6-35259A58A6C1")]
    [ComVisible(true)]
    ...
    [Guid("0F780F00-4911-45C9-8A17-0F660D1B573E")]
    ...
    public class GameSettings : ISettings
    {
        ...
        //---
        public int WallStartX { get; set; } = 1; // Координата Х для земли
        public int WallStartY { get; set; } = 20; // Координата У для земли
        public char Wall { get; set; } = '-'; // Первоначальная форма земли
        public int NumberOfWallRows { get; set; } = 1; // Кол-во рядов земли
        public int NumberOfWall { get; set; } = 80; // Кол-во земли
        //---
    ...
    [Guid("C82790B6-428E-46F5-9BFF-25F066554C2C")]
    [ClassInterface(ClassInterfaceType.None)]
    [ComVisible(true)]
